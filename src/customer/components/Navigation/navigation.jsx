    ...
    <div className="bg-white z-50 ">
      ...
      <header className="relative bg-white">
        ...
        <h3 className="flex h-10 items-center justify-center  px-4 text-sm font-medium text-white sm:px-5 lg:px-8 text-center">
         Made in India &nbsp;&nbsp; |   50% OFF on First order   | &nbsp;&nbsp;  Free delivery on first order 
        </h3>
        </div>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0 object-center space-x-2 ">
                <a href="#" className=' flex gap-2'>
                  <img
                    ...
                    alt=""
                  />
                  <span className=" text-xl Poppins font-extrabold space-x-3 pt-3 pr-5">GlintGlam</span>
                </a>
              </div>
              ...
              <div className="ml-auto flex items-center">
               ...
               >
                ...
                <Button onClick={handleOpen} className=' text-sm font-medium text-gray-700 hover:text-gray-800s'>
              SignIn
                </Button>
                )}
