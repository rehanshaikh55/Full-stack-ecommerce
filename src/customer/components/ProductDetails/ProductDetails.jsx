  ...
  return (
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
           ...
           <section className='pt-10 flex flex-col'>
            ...
            <div className='border h-full w-[75vw] p-7 hidden lg:flex  '>
    ...
    <Grid item xs={5}>
      ...
      <div className='flex items-center space-x-3'>
        ...
        <p className=' opacity-65'>Total Rating 119</p>
      </div>
      <Box className=" mt-5">
      ...
      <Box className=" mt-5">
        ...
        <Grid item xs={7}>
          <LinearProgress sx={{bgcolor:'#d0d0d0',borderRadius:4,height:7}} variant='determinate' value={10} color='error' />
           ...
           <section className=' pt-12 w-[75vw]'>
            <h1 className=' text-xl font-semibold py-1'> Similer Product</h1>
            <div className=''>
