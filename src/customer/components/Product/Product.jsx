                    ...
                    {({ open }) => (
                      <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className=" pl-4 flex w-80 justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                          ...
                          <Disclosure.Panel className="pt-6">
                            <div className="space-y-4 items-center pl-4 ">
                              <FormControl>
                              <RadioGroup
                              ...
                              >
                                {section.options.map((option, optionIdx) => (
                                  <>
                                    <FormControlLabel
                                    onChange={(e)=>handleRedioFilterChange(e,section.id)}
                                      value={option.value}
                                      control={<Radio />}
                                      label={option.label}
                                    />
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <h2 className=" text-xl font-semibold text-gray-900 pb-2">
                    ...
                    <FilterListIcon color="black" className=" " />
                    </div>
              <form className="hidden lg:block">
                {filters.map((section) => (
                  ...
                  >
                    {({ open }) => (
                      <>
                        <h3 className="-my-3 flex-root">
                          <Disclosure.Button className="flex w-full  item-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                ...
                {singleFilter.map((section) => (
                  ...
                  >
                    {({ open }) => (
                      <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className=" flex w-full  justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                              <span className="font-medium "></span>
                              <FormLabel
                              sx={{
                                color:'black',
